...
export class PaymentComponent implements OnInit {
  ...
  constructor(private _ordersService:OrderService,private _userService:OrderDetailsService,private _snackBar:MatSnackBar, private _giftService: GiftdisplayService ,private router:Router) {
